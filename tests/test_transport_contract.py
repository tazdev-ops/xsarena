...
from xsarena.core.backends.transport import BackendTransport, BaseEvent
...
async def test_bridge_transport_send_method():
    ...
    transport = BridgeV2Transport(base_url="http://127.0.0.1:5102/v1")  # Use localhost instead of 'test'
