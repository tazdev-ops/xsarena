...
def test_jobstore_events_parsing():
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        # Write test events
        events = [
            {"type": "job_started", "job_id": "test_job", "timestamp": "2023-01-01T00:00:00Z"},
            {"type": "chunk_started", "job_id": "test_job", "chunk_idx": 0, "timestamp": "2023-01-01T00:00:01Z"},
            {"type": "chunk_done", "job_id": "test_job", "chunk_idx": 0, "timestamp": "2023-01-01T00:00:02Z"},
            {"type": "chunk_started", "job_id": "test_job", "chunk_idx": 1, "timestamp": "2023-01-01T00:00:03Z"},
            {"type": "chunk_done", "job_id": "test_job", "chunk_idx": 1, "timestamp": "2023-01-01T00:00:04Z"},
            {"type": "chunk_started", "job_id": "test_job", "chunk_idx": 2, "timestamp": "2023-01-01T00:00:05Z"},
        ...
        assert last_chunk == 1, f"Expected last completed chunk to be 1, got {last_chunk}"
        ...
        assert last_chunk_empty == -1, f"Expected -1 for empty file, got {last_chunk_empty}"
