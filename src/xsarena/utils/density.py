...
_STOPWORDS = {
    ...
    "with","as","is","are","was","were","be","been","being","that","this","those","these",
    "it","its","from","into","over","under","about","above","below","up","down","out","off",
}

# A compact set of hedges/fillers/adverbs worth suppressing
_FILLERS = {
    "actually","basically","clearly","simply","obviously","literally","just","kind of","sort of",
    "very","really","quite","perhaps","maybe","likely","possibly","probably","generally",
    "in fact","indeed","note that","as you can see","as we saw","in summary",
}
